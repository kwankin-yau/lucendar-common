 ...
 * @see Date
 */
public class NtpTimeStamp implements Serializable, Comparable<NtpTimeStamp> {
     ...
     */
    public static NtpTimeStamp getNtpTime(final long dateMillis) {
        return new NtpTimeStamp(toNtpTime(dateMillis));
    }
     ...
     * @throws NumberFormatException - if the string does not contain a parsable timestamp.
     */
    public static NtpTimeStamp parseNtpString(final String s) throws NumberFormatException {
        return new NtpTimeStamp(decodeNtpHexString(s));
    }
     ...
     */
    public static long toNtpTime(final long millis) {
     ...
     */
    public NtpTimeStamp(final Date d) {
     ...
     */
    public NtpTimeStamp(final long ntpTime) {
     ...
     * @throws NumberFormatException - if the string does not contain a parsable timestamp.
     */
    public NtpTimeStamp(final String hexStamp) throws NumberFormatException {
     ...
     *
     * @param anotherNtpTimeStamp - the <code>TimeStamp</code> to be compared.
     ...
     */
    @Override
    public int compareTo(final NtpTimeStamp anotherNtpTimeStamp) {
        final long thisVal = this.ntpTime;
        final long anotherVal = anotherNtpTimeStamp.ntpTime;
    ...
    public boolean equals(final Object obj) {
        if (obj instanceof NtpTimeStamp) {
            return ntpTime == ((NtpTimeStamp) obj).ntpValue();
        }
        return false;
    }
